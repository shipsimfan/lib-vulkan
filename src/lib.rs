...
pub use bindings::{
    ...
    VkCompositeAlphaFlagsKHR as CompositeAlphaFlags, VkDynamicState as DynamicState,
    VkExtent2D as Extent2D, VkExtent3D as Extent3D, VkFormat as Format,
    ...
    VkSampleCountFlags as SampleCountFlags, VkShaderStageFlagBits as ShaderStageFlagBits,
    VkShaderStageFlags as ShaderStageFlags, VkSharingMode as SharingMode,
