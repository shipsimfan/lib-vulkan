...
pub use self::core::{
    ...
    VkImageUsageFlags, VkImageViewType, VkInstance, VkPhysicalDeviceType, VkPrimitiveTopology,
    VkQueueFamilyProperties, VkQueueFlagBits, VkQueueFlags, VkResult, VkSampleCountFlagBits,
    VkSampleCountFlags, VkShaderStageFlagBits, VkShaderStageFlags, VkSharingMode,
    VkSpecializationMapEntry, VkVersion, VkVertexInputAttributeDescription,
    VkVertexInputBindingDescription, VkVertexInputRate, VK_API_VERSION_1_0, VK_API_VERSION_1_1,
