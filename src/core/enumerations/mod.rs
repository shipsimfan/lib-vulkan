...
mod memory_heap_flag_bits;
mod memory_property_flag_bits;
mod object_type;
...
pub use memory_heap_flag_bits::VkMemoryHeapFlagBits;
pub use memory_property_flag_bits::VkMemoryPropertyFlagBits;
