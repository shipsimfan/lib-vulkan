...
pub enum VkStructureType {
    ...
    #[cfg(any(
        all(feature = "vk_version_1_1", feature = "vk_khr_swapchain"),
    ...
    #[cfg(feature = "vk_amd_raserization_order")]
    ...
    #[cfg(feature = "vk_gpgstream_descriptor_surface")]
    ...
    #[cfg(feature = "vk_googledisplay_timing")]
    ...
    #[cfg(feature = "vk_imgrelaxed_line_rasterization")]
    ...
    #[cfg(all(
        ...
        any(feature = "vk_khr_format_feature_flags2", feature = "vk_version_1_3")
    ))]
    AndroidHardwareBufferFormatProperties2Android = 1000129006,

    /// Provided by [`amd_xshader_enqueue`]
    #[cfg(feature = "vk_amd_xshader_enqueue")]
    ...
    #[cfg(feature = "vk_secamigo_profiling")]
    ...
    #[cfg(all(feature = "vk_khr_maintenance6", feature = "vk_ext_descriptor_buffer"))]
