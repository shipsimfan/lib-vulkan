...
flags! {
    ...
    pub enum VkCommandPoolCreateFlag {
        /// [`VkCommandPoolCreateFlag::TransientBit`] specifies that command buffers allocated from
        ...
        /// [`VkCommandPoolCreateFlag::ResetCommandBufferBit`] allows any command buffer allocated
        ...
        /// [`VkCommandPoolCreateFlag::ProtectedBit`] specifies that command buffers
