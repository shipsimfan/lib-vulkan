...
flags! {
    ...
    pub enum VkMemoryHeapFlag {
        /// [`VkMemoryHeapFlag::DeviceLocal`] specifies that the heap corresponds to
        ...
        /// [`VkMemoryHeapFlag::MultiInstance`] specifies that in a logical device
        ...
        /// [`VkMemoryHeapFlag::TileMemoryQcom`] bit specifies that the heap corresponds to
        /// tile memory.
        ///
