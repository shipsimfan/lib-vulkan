...
flags! {
    ...
    pub enum VkDeviceGroupPresentModeFlagKhr {
        /// [`VkDeviceGroupPresentModeFlagKhr::LocalBitKhr`] specifies that any physical device
        /// with a presentation engine can present its own swapchain images.
        LocalBitKhr = 0x00000001,

        /// [`VkDeviceGroupPresentModeFlagKhr::RemoteBitKhr`] specifies that any physical device
        /// with a presentation engine can present swapchain images from any physical device in its
        /// `present_mask`.
        RemoteBitKhr = 0x00000002,

        /// [`VkDeviceGroupPresentModeFlagKhr::SumBitKhr`] specifies that any physical device with
        /// a presentation engine can present the sum of swapchain images from any physical devices in
        /// its `present_mask`.
        SumBitKhr = 0x00000004,

        /// [`VkDeviceGroupPresentModeFlagKhr::LocalMultiDeviceBitKhr`] specifies that multiple
