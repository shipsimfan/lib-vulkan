...
const impl Default for VkSwapchainCreateInfoKhr {
    fn default() -> Self {
        VkSwapchainCreateInfoKhr {
            ...
            image_usage: VkImageUsageFlags::empty(),
            image_sharing_mode: VkSharingMode::Exclusive,
            queue_family_index_count: 0,
            queue_family_indices: null(),
            pre_transform: VkSurfaceTransformFlagsKhr::empty(),
            composite_alpha: VkCompositeAlphaFlagsKhr::empty(),
