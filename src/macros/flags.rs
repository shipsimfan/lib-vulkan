...
macro_rules! flags {
    {
        ...
        const impl From<$crate::VkFlags> for $struct_name {
            fn from(flag: $crate::VkFlags) -> Self {
                $struct_name(flag)
            }
        }

        const impl From<u32> for $struct_name {
...
macro_rules! flags_no_bits {
    (
        ...
        const impl Into<$crate::VkFlags> for $struct_name {
            fn into(self) -> $crate::VkFlags {
                self.0
            }
        }

        const impl Into<u32> for $struct_name {
            fn into(self) -> u32 {
                self.0.into()
            }
        }
        ...
        const impl PartialEq<$crate::VkFlags> for $struct_name {
            fn eq(&self, other: &$crate::VkFlags) -> bool {
                self.0.eq(other)
            }
        }

        const impl PartialEq<u32> for $struct_name {
